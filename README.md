...
корзина, checkout, email-уведомления о заказе и рабочее место менеджера в
...
- [Доставка: исследование и рекомендация (СДЭК / Яндекс)](docs/delivery-providers-research.md)
