...
test("covers every editable storefront schema with a canonical layout", () => {
  const expectedFields: Record<string, string[]> = {
    ...
    "capability.model": ["slug", "name", "description", "productModel", "image"],
    "capability.spec-row": ["label", "cells"],
    "capability.spec-cell": ["value"],
    ...
    "home.articles-preview": ["eyebrow", "title", "subtitle", "linkLabel"],
